...
* [**SIGMETRICS**] P4Bench: A Scalable and Adaptive Oracle-Backed Benchmark for P4 Programming with Large Language Models\
    Zirong Gan, Shuyi Liao, Yannian Niu, Xinyue Zheng, Tingting Yu, **Minmei Wang**\
...
* [**MASS**] CrossZK: Privacy-Preserving Inter-Organizational Verification for Consortium Blockchains\
    Md Omer Danish, Sammy Tesfai, **Minmei Wang**, Haofan Cai, Xiaoxue Zhang\
    IEEE International Conference on Mobile Ad-Hoc and Smart Systems (MASS), 2026.

* [**INFOCOM Workshop**] Sensing-Communication Tradeoffs in Closed-Loop ISAC via Covariance-Aware Optimization\
    Anindya Bal, Thomas Yang, **Minmei Wang**, Hanqing Guo, Haofan Cai\
...
* [**ToN**] COIN: An Efficient Indexing Mechanism for Unstructured Data Sharing systems.\
    Junjie Xie, Chen Qian, Deke Guo, **Minmei Wang**, Ge Wang, Honghui Chen\
    IEEE Transactions on Networking (ToN), 2021.\
